...
public final class RatTerm {
    ...
    public RatTerm add(RatTerm arg) {
        if (this.isNaN() || arg.isNaN()) {
            ...
            throw new IllegalArgumentException("adding the 2 terms require them to have same exponents.");
        }
    ...
    public RatTerm sub(RatTerm arg) {
        if (this.isNaN() || arg.isNaN()) {
            ...
            throw new IllegalArgumentException("subtracting 2 terms requires them to have same exponents.");
        }
